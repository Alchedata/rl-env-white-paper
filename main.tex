...
% Title
\title{\textbf{The Environment Layer: Building Infrastructure for Agentic AI Training}}
\date{\today}
\author{
  Fei Wang \\
  Alchedata AI \\
...
\begin{enumerate}[label={[\arabic*]}]
    ...
    \item Brockman, G., Cheung, V., Pettersson, L., Schneider, J., Schulman, J., Tang, J., \& Zaremba, W. (2016). OpenAI Gym. \textit{arXiv preprint arXiv:1606.01540}.

    \item C\^ot\'e, M.-A., Kapturowski, S., Hosseini, M., et al. (2018). TextWorld: A learning environment for text-based games. \textit{Workshop on Computer Games}.

    \item Shridhar, M., Yuan, X., C\^ot\'e, M.-A., Bisk, Y., Trischler, A., \& Hausknecht, M. (2021). ALFWorld: Aligning text and embodied environments for interactive learning. \textit{ICLR}.

    \item Liu, E. Z., Guu, K., Pasupat, P., et al. (2018). Reinforcement learning on web interfaces using workflow-guided exploration. \textit{ICLR}.

    \item Savva, M., Kadian, A., Maksymets, O., et al. (2019). Habitat: A platform for embodied AI research. \textit{ICCV}.

    \item Yu, T., Quillen, D., He, Z., et al. (2020). Meta-World: A benchmark and evaluation for multi-task and meta reinforcement learning. \textit{Conference on Robot Learning}.

    \item James, S., Davison, A. J., \& Johns, E. (2020). RLBench: The robot learning benchmark and learning environment. \textit{IEEE Robotics and Automation Letters}, 5(2), 3019-3026.

    \item Fan, L., Wang, G., Tang, Y., et al. (2022). MineDojo: Building open-ended embodied agents with internet-scale knowledge. \textit{NeurIPS}, 35.

    \item Community BEHAVIOR Benchmark. (2024). BEHAVIOR-1K: A benchmark for embodied household activities. \textit{Project documentation and benchmark release}.
